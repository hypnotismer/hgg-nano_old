...
#                     vertex_associator = "primaryVertexAssociation:original"
            ...
            ##!! custom DeepHWW
            if btagInfo in ['pfMassDecorrelatedDeepHWWV1TagInfos', 'pfMassDecorrelatedInclParticleTransformerV1TagInfos', 'pfMassDecorrelatedInclParticleTransformerV2TagInfos', 'pfMassDecorrelatedInclParticleTransformerAK15V2TagInfos', 'pfMassDecorrelatedXgggFinetuneV2TagInfos']:
                if pfCandidates.value() == 'packedPFCandidates':
                    # case 1: running over jets whose daughters are PackedCandidates (only via updateJetCollection for now)
                    puppi_value_map = ""
                    vertex_associator = ""
