...
def nanoTuples_customizeData(process):
    process = nanoTuples_customizeCommon(process, False, addAK15=True, addAK8=False, addPFcands=False, customAK8Taggers=[], customAK15Taggers=['InclParticleTransformerAK15V2-hgg'])
...
def nanoTuples_customizeMC(process):
    process = nanoTuples_customizeCommon(process, True, addAK15=True, addAK8=False, addPFcands=False, customAK8Taggers=[], customAK15Taggers=['InclParticleTransformerAK15V2-hgg'])
