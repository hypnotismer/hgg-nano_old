...
#ifndef PHYSICSTOOLS_NANOTUPLES_INTERFACE_FATJETMATCHING_H_
#define PHYSICSTOOLS_NANOTUPLES_INTERFACE_FATJETMATCHING_H_
...
#endif /* PHYSICSTOOLS_NANOTUPLES_INTERFACE_FATJETMATCHING_H_ */
